...
module.exports = (searchString) => {
    ...
    const googleUrl = 'https://www.googleapis.com/customsearch/v1?q=' + searchString.trim() + '&num=10&start=' + start + '&cx=' + process.env.googlecx + '&searchType=image&key=' + process.env.googleapi;  
